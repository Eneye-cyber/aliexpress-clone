<template>
  <div id="ItemPage" class="mt-4 max-w-[1200px] mx-auto px-2">
    <div class="md:flex gap-4 justify-between mx-auto w-full">
      <div class="md:w-[40%]">
        <img v-if="currentImage" class="rounded-lg object-fit" :src="currentImage" :alt="`${product.title}`">
        <div v-if="!!images && !!images.length" class="flex items-center justify-center mt-2">
          <div v-for="image in images">
            ...
            :alt="`${product.title}`" width="70" class="rounded-md object-fit border-[3px]" @click="currentImage = image"
...
const priceComputed = computed(() => product.price / 100)
