    ...
    <nuxt-link :to="`/item/${product.id}`">
      ...
      <div id="ProductDetail">
        ...
        <p class="flex items-center px-1 pt-0.5 text-xs text-[#252525]">
          5,000+ sold <Icon name="material-symbols:star-rate" color="#757575" class="ml-1.5"/> 4.5
        </p>

        <p class="px-1 pt-0.5 text-xs text-[#252525]">{{ productTitle }}</p>
...
const productTitle = computed(() => product.value.title.substring(0, 60))
</script>